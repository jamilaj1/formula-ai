...
def init_connections():
    ...
    # الحل القاطع: نترك المكتبة تختار أفضل مسار مستقر تلقائياً بدلاً من v1beta
...
def render_main():
    ...
    if prompt := st.chat_input("Enter your manufacturing query...", key="chat_input_unique"):
        ...
        with st.chat_message("assistant"):
            try:
                # إرسال الاستفسار للموديل المستقر بصفة مهندس خبير
